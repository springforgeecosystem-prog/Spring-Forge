...
//            println("🟩 ML Prediction: ${result.anti_pattern}")
//
//            // ===== CHEATING DEMO OUTPUT (MINIMAL) =====
//            if (result.anti_pattern == "tight_coupling_new_keyword") {
//
//                val demoOutput = """
//🟥 Anti-Pattern Detection Panel:
//⚠️ TIGHT COUPLING DETECTED (Direct Object Creation)
//
//🔴 Problem Identified
//├─ Direct usage of `new` keyword between layers
//│
//├─ Affected Components:
//│  ├─ UserController.java
//│  ├─ UserService.java
...
//
//                println(demoOutput)
//                panel?.showMessage(demoOutput)
//            }
//
//            NotificationGroupManager.getInstance()
//                .getNotificationGroup("SpringForge")
//                .createNotification(
//                    "Anti Pattern: ${result.anti_pattern}",
